...
# name of models for testing == ["m0", "m1", "m2"]
...
def get_inputs():
    ...
    inputs = [os.path.join(input_streams_root, x) for x in ['funky_sample.wav', 'WhiteNoise.wav', 'Amp_Sweep.wav']]
